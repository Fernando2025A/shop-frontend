...
function Card({ textSize, title, link, text, btnText, titleColor, img, btnColor }: Props) {
  return (
    <div className="card" style={{ overflowY: 'auto', alignItems: "center", maxWidth: "85vw"}}>
      <img style={{ maxWidth: "85vw", height: "45vw"}} src={img} className="card-img-top" alt="img"></img>
      <div style={{ backgroundColor: 'black', width: "90vw"}} className="card-body">
